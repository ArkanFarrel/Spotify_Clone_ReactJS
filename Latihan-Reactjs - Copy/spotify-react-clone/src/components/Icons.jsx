...
const BackdIcon = ({ size }) => {
  return (
    <svg
      ...
      height="22"
      width="22"
      class="Svg-sc-1bi12j5-0 hDgDGI IYDlXmBmmUKHveMzIPCF"
      viewBox="0 0 24 24"
    >
      <path
...
const DirIcon = ({ size }) => {
  return (
    <svg
      ...
      height="16"
      width="16"
      class="Svg-sc-1bi12j5-0 hDgDGI eAXFT6yvz37fvS1lmt6k"
      viewBox="0 0 16 16"
    >
...
const TopSearchIcon = ({ size }) => {
  return (
    <svg
      ...
      height="24"
      width="24"
      class="Svg-sc-1bi12j5-0 hDgDGI mOLTJ2mxkzHJj6Y9_na_"
      aria-hidden="true"
      viewBox="0 0 24 24"
    >
      <path
...
//   const Component = icons1[name];
//   return <Component size={size1} />;
// };
// export { Icon1 };

// const Icon1 = ({name1,size1 = 30 }) => {
//   const icons1 = {
//     home: HomeIcon,
//     search: SearchIcon,
//     lib: LibIcon,
//   };
//   const Component1 = icons1[name1];
//   return <Component1 size={size1} />;
// };
// export { Icon1 };
