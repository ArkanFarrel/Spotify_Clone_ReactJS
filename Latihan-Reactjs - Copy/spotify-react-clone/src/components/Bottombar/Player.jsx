          ...
          <div className="flex items-center">
            <div className="flex items-center">
              ...
              <div>
                ...
                <h6 className="text-[0.688rem] text-tartist">
                  {current.artist}
                </h6>
              </div>
            </div>
...
//   useEffect(() => {
//     if (current && controls && !state.playing) {
//       controls.play();
//     }
//   }, [current, controls, state.playing]);
...
//             max={state.duration || 1}
//             value={state.time}
//             onChange={(value) => controls && controls.seek(value)}
//           />
//           <div className="text-[11px] text-gribottom">
//             {secondsToTime(state.duration)}
//           </div>
...
//         </button>
//         <button
//           onClick={() => controls && controls[state.muted ? "unmute" : "mute"]()}
//           className="w-8 h-8 flex items-center justify-center text-white text-opacity-70 hover:text-opacity-100"
//         >
//           <Icon name={volumeIcon} />
//         </button>
...
//             value={state.muted ? 0 : state.volume}
//             onChange={(value) => {
//               controls && controls.unmute();
//               controls && controls.volume(value);
//             }}
//           />
//         </div>
//         <button className="w-8 h-8 flex items-center justify-center text-white text-opacity-70 hover:text-opacity-100">
